      ...
      >
        ...
        >
          <Typography variant="h4" sx={{ py: 4, px: { xs: 2, md: 35 } }}>
            We are nerds building solutions and creating a voice for everyone
            through SMS messaging (with really cool tech).
          </Typography>
          ...
          >
            ...
            <Grid item md={7} sx={{ pr: { md: 15, xs: 0 } }}>
              ...
              <Typography variant="h4" sx={{ py: 4, fontWeight: 600 }}>
                SMS messaging app with end to end encyption and other mind
                blowing features
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                ...
                use-case of the platform is sending out emails from platforms
                such as Gmail accounts. This becomes a useful tool in cases
                where access to the internet is limited or completely
                unavailable.
              </Typography>
